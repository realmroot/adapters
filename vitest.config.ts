          ...
          cloudflareTest(async () => ({
            ...
            miniflare: {
              ...
              bindings: {
                ...
                REALMROOT_APPLICATION_CLIENT_ID: 'adapter-client',
                REALMROOT_APPLICATION_CLIENT_SECRET: 'adapter-secret',
                REALMROOT_GITHUB_RESOURCE_SERVER_ID: 'github-resource-server',
              },
            },
          })),
        ],
