/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 3d792366556aa0cc50a755d99f527557)
...
interface __BaseEnv_Env {
	...
	REALMROOT_AGENTINFO_ENDPOINT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REALMROOT_ISSUER" | "REALMROOT_JWKS_URL" | "REALMROOT_AGENTINFO_ENDPOINT" | "GITHUB_API_ORIGIN" | "GITHUB_APP_ID" | "GITHUB_PRIVATE_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
