/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 3395f9fa4ba66e7161740a66c8c7a39e)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	REALMROOT_ISSUER: string;
	REALMROOT_JWKS_URL: string;
	REALMROOT_AGENT_PROFILE_URI_TEMPLATE: string;
	GITHUB_API_ORIGIN: string;
	GITHUB_UPLOADS_ORIGIN: string;
	LINEAR_API_ORIGIN: string;
	LINEAR_AUTHORIZATION_ORIGIN: string;
	CLOUDFLARE_API_ORIGIN: string;
	CLOUDFLARE_AUTHORIZATION_ORIGIN: string;
	CONTEXT7_API_ORIGIN: string;
	CONTEXT7_OAUTH_ISSUER: string;
	TODOIST_API_ORIGIN: string;
	TODOIST_AUTHORIZATION_ENDPOINT: string;
	TODOIST_LOGIN_ENDPOINT: string;
	TODOIST_TOKEN_ENDPOINT: string;
	TODOIST_REGISTRATION_ENDPOINT: string;
	TODOIST_USERINFO_ENDPOINT: string;
	...
	LINEAR_CREDENTIAL_ENCRYPTION_KEY: string;
	LINEAR_WEBHOOK_SECRET: string;
	ADAPTER_OAUTH_SIGNING_PRIVATE_JWK: string;
	CLOUDFLARE_CLIENT_ID: string;
	CLOUDFLARE_CLIENT_SECRET: string;
	CLOUDFLARE_CREDENTIAL_ENCRYPTION_KEY: string;
	CONTEXT7_CREDENTIAL_ENCRYPTION_KEY: string;
	TODOIST_CREDENTIAL_ENCRYPTION_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REALMROOT_ISSUER" | "REALMROOT_JWKS_URL" | "REALMROOT_AGENT_PROFILE_URI_TEMPLATE" | "GITHUB_API_ORIGIN" | "GITHUB_UPLOADS_ORIGIN" | "LINEAR_API_ORIGIN" | "LINEAR_AUTHORIZATION_ORIGIN" | "CLOUDFLARE_API_ORIGIN" | "CLOUDFLARE_AUTHORIZATION_ORIGIN" | "CONTEXT7_API_ORIGIN" | "CONTEXT7_OAUTH_ISSUER" | "TODOIST_API_ORIGIN" | "TODOIST_AUTHORIZATION_ENDPOINT" | "TODOIST_LOGIN_ENDPOINT" | "TODOIST_TOKEN_ENDPOINT" | "TODOIST_REGISTRATION_ENDPOINT" | "TODOIST_USERINFO_ENDPOINT" | "GITHUB_APP_ID" | "GITHUB_PRIVATE_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_WEBHOOK_SECRET" | "LINEAR_CLIENT_ID" | "LINEAR_CLIENT_SECRET" | "LINEAR_CREDENTIAL_ENCRYPTION_KEY" | "LINEAR_WEBHOOK_SECRET" | "ADAPTER_OAUTH_SIGNING_PRIVATE_JWK" | "CLOUDFLARE_CLIENT_ID" | "CLOUDFLARE_CLIENT_SECRET" | "CLOUDFLARE_CREDENTIAL_ENCRYPTION_KEY" | "CONTEXT7_CREDENTIAL_ENCRYPTION_KEY" | "TODOIST_CREDENTIAL_ENCRYPTION_KEY">> {}
}
